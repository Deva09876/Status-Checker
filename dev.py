...
async def main_devchecker():
    async with app:
        ...
        while True:
                ...
                await app.send_message(-1001772170556, f"🚨 I have checked the status of your bot. kindly have a look at : https://t.me/{link}/{MESSAGE_ID}\x━━━━━━━━━━━━━━━━━━━━━━x", disable_web_page_preview=True)
